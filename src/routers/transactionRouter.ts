...
import { transferValidator } from "../services/validatorServices"
...
transactionRouter.post("/transfer", [requireAuth, ...transferValidator,validateRequest ], transaction_post)
